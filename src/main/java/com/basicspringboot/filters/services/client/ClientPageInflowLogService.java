package com.basicspringboot.filters.services.client;

import com.basicspringboot.filters.dto.BSQuery;
import com.basicspringboot.filters.interfaces.SheetSetter;
import com.basicspringboot.filters.models.others.ClientPageInflowLog;
import com.basicspringboot.filters.services._BSService;
import com.basicspringboot.filters.utils.Utils;
...
public class ClientPageInflowLogService extends _BSService<ClientPageInflowLog> {
    ...
    public long findAllTotalCount(BSQuery bsq) {
        return master.queryForObject(bsq.toObjectSql("COUNT(*)"), Long.class);
    }
