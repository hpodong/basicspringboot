package com.basicspringboot.filters.models;
...
import com.basicspringboot.filters.exceptions.BSValidationException;
import com.basicspringboot.filters.interfaces.BSEnum;
import com.basicspringboot.filters.interfaces.BSModelI;
...
public abstract class _BSModel implements BSModelI {

    private int row_num;

    public _BSModel(ResultSet rs, int row_num) {
